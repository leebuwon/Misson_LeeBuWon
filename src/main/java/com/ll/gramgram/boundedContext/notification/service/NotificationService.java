...
public class NotificationService {
    ...
    @Transactional
    public RsData<Notification> makeModifyAttractiveTypeCode(LikeablePerson likeablePerson, int oldAttractiveTypeCode) {

        return make(likeablePerson, "MODIFY_ATTRACTIVE_TYPE_CODE", oldAttractiveTypeCode, likeablePerson.getFromInstaMember().getGender());
    }
    ...
    @Transactional
    public RsData<Notification> markAsRead(List<Notification> notifications) {
